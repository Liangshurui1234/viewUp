...
public class BaiMiDetailedAndTabRlvAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BaiMiDetailedAndTabRlvAdapter(ArrayList<BaiMiDetailedTreadBean.ResultBean.ReviewsBean> mArr, Context context) {
        this.mArr = mArr;
        this.context = context;
    }

    public void setmArr(ArrayList<BaiMiDetailedTreadBean.ResultBean.ReviewsBean> mArr) {
        this.mArr = mArr;
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if (viewHolder instanceof VH) {
            VH vh = (VH) viewHolder;
            BaiMiDetailedTreadBean.ResultBean.ReviewsBean reviewsBean = mArr.get(i);
            final String img = reviewsBean.getUserPhoto();
            vh.tvBaimiTabTime.setText(reviewsBean.getCreatedAt());
            GlideUtils.glide(img, vh.imgBaimiTab);
            vh.tvBaimiTabTitle.setText(reviewsBean.getUserName());
